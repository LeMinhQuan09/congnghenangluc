...
if ( ! function_exists( 'is_php' ) ) {
	 ...
	 * @return  bool
	 */
	function is_php( string $version = '5.0.0' ): bool {
...
if ( ! function_exists( 'youtube_iframe' ) ) {
	 ...
	 * @return string|null
	 */
	function youtube_iframe( $url, int $autoplay = 0, bool $lazyload = true, bool $control = true ): ?string {
...
if ( ! function_exists( 'youtube_image' ) ) {
	 ...
	 * @return string
	 */
    function youtube_image($url, $resolution = []): string {
