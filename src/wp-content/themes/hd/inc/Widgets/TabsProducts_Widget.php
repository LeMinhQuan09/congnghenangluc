...
class TabsProducts_Widget extends Abstract_Widget {
	public function __construct() {
		$this->widget_description = __( 'Your site&#8217;s filter tabs products by category.', 'hd' );
		$this->widget_name        = __( 'W - Tabs Products', 'hd' );
		$this->settings           = [
			'title' => [
				'type'  => 'text',
				'std'   => '',
                        ...
                        <div class="tabs-nav">
                            <ul>
								<?php foreach ( $products_tabs as $i => $cat_id ) :
									...
									?>
                                    <li>
                                        <a data-cat_id="<?= $cat_id ?>" href="<?php echo '#' . $rand . $i . $cat_id ?>"
