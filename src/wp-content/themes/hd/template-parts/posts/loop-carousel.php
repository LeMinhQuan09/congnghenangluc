...
$auto = ! empty( $args['auto_image'] ) ? ' auto': '';
...
<article class="item cell">
	...
	<div class="cover-content">
        ...
        <?php endif; ?>
		<h3 class="h6"><a class="<?=$blank_class?>" href="<?= get_permalink(); ?>" title="<?php echo esc_attr($post_name); ?>"><?= $post_name; ?></a></h3>
		...
		<a class="view-detail" href="<?= get_permalink(); ?>" title="<?php echo esc_attr($post_name); ?>" data-glyph="">
			<span><?php echo __('Chi tiết', 'hd'); ?></span>
		</a>
        <?php endif; ?>
	</div>
</article>
