...
if (!class_exists('Videos_PostType')) {
    class Videos_PostType
    {
        public function __construct()
        {
            add_action('init', [&$this, 'video_post_type'], 10);
            add_action('init', [&$this, 'video_category'], 10);
        }
        ...
        public function video_post_type()
        {
            ...
            $labels = [
                'name'                  => __('Videos', 'hd'),
                'singular_name'         => __('Video', 'hd'),
                'menu_name'             => __('Videos', 'hd'),
                'name_admin_bar'        => __('Videos', 'hd'),
                'archives'              => __('Item Archives', 'hd'),
                'attributes'            => __('Item Attributes', 'hd'),
                'parent_item_colon'     => __('Parent Item:', 'hd'),
                'all_items'             => __('All Videos', 'hd'),
        ...
        public function video_category()
        {
            ...
            $labels = [
                'name'                       => __('Video Categories', 'hd'),
                'singular_name'              => __('Video Category', 'hd'),
                'menu_name'                  => __('Video Categories', 'hd'),
